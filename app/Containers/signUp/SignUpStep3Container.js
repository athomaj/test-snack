    ...
    return (
        <SafeAreaView style={{width: '100%', height: '100%'}}>
            <ScrollView style={{...sharedStyles.wrapperHeaderSpace}} contentContainerStyle={{ paddingHorizontal: 15, paddingTop: isIphoneX() ? 40 : '8%' }}>
                ...
                <Text style={{ ...sharedStyles.h2, width: '100%', marginBottom: 5 }}>Où habites-tu ? </Text>
                <Text style={{ ...sharedStyles.shortText, height: 55, marginBottom: 19 }}>Participe avec nous à développer la vie du quartier de ta ville.</Text>
                <FlatList
                    data={cities}
